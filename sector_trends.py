...
OUTPUT_DIR = "outputs/sector_trends"
...
# ------------------------------
# Plot closing price trends for each sector
for sector_name, tickers in sectors.items():
    ...
    plt.title(f"{sector_name} - Closing Price Trends")
    plt.xlabel("Date")
    plt.ylabel("Close Price")
    plt.legend()
    plt.tight_layout()
    
    # Save chart in sector_trends folder
    output_file = os.path.join(OUTPUT_DIR, f"{sector_name.replace(' ','_')}_trend.png")
